...
export default function Privacy() {
  return (
    <div style={{ fontFamily: 'var(--font-sans)', background: '#FFFFFF' }}>
      <Helmet>
        <title>Privacy Policy — Linki</title>
        <meta name="description" content="Learn how Linki collects, uses, and protects your personal data. We are committed to transparency and GDPR compliance." />
        <link rel="canonical" href="https://getlinki.app/privacy" />
        <meta property="og:title" content="Privacy Policy — Linki" />
        <meta property="og:description" content="Learn how Linki collects, uses, and protects your personal data. We are committed to transparency and GDPR compliance." />
        <meta property="og:url" content="https://getlinki.app/privacy" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Linki" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Privacy Policy — Linki" />
        <meta name="twitter:description" content="Learn how Linki collects, uses, and protects your personal data. We are committed to transparency and GDPR compliance." />
      </Helmet>
      <MarketingNav />
