...
// Requires CMS to be running at PAYLOAD_URL

const PAYLOAD_URL = process.env.PAYLOAD_URL || 'http://localhost:3001'
const ADMIN_EMAIL = process.env.SEED_EMAIL || 'admin@linki.app'
...
async function login() {
  const data = await post('/users/login', { email: ADMIN_EMAIL, password: ADMIN_PASSWORD })
...
const vsPages = [
  {
    ...
    competitorEdge: [
      { point: 'In-editor link insertion directly inside the WordPress post editor' },
      { point: 'Auto-linking rules that automatically add links as you publish new content' },
      { point: 'Orphaned page detection built into the dashboard' },
    ],
    bottomLine:
    ...
    metaTitle: 'Linki vs Link Whisper — Internal Linking Tool Comparison',
    metaDescription: 'Compare Linki and Link Whisper for internal linking. See which tool works on any website, offers AI suggestions, session saving, and a free tier.',
  },
  {
    slug: 'linkstorm',
    name: 'LinkStorm',
    ...
    competitorEdge: [
      { point: 'Google Search Console integration for traffic-informed linking decisions' },
      { point: 'Cross-site and multi-domain linking support' },
      { point: 'Visual link map showing the full internal link graph' },
    ],
    bottomLine:
    ...
    metaTitle: 'Linki vs LinkStorm — Internal Linking Tool Comparison',
    metaDescription: 'Compare Linki and LinkStorm for internal linking. See which tool requires no installation, offers a free tier, and provides AI-powered suggestions.',
  },
  {
    slug: 'inlinks',
    name: 'InLinks',
    ...
    competitorEdge: [
      { point: 'Deep entity SEO analysis and knowledge graph construction' },
      { point: 'Automated schema markup generation across your entire site' },
      { point: 'Continuous monitoring and automatic re-optimisation as content changes' },
    ],
    bottomLine:
    ...
    metaTitle: 'Linki vs InLinks — Internal Linking Tool Comparison',
    metaDescription: 'Compare Linki and InLinks for internal linking. See which tool offers simpler setup, lower pricing, and focused AI-powered link suggestions.',
  },
  {
    slug: 'linkboss',
    name: 'LinkBoss',
    ...
    competitorEdge: [
      { point: 'Auto-generates contextual linking paragraphs to insert around new links' },
      { point: 'Topic cluster builder for structuring pillar and supporting content' },
      { point: 'Deep semantic analysis of content relationships within WordPress' },
    ],
    bottomLine:
    ...
    metaTitle: 'Linki vs LinkBoss — Internal Linking Tool Comparison',
    metaDescription: 'Compare Linki and LinkBoss for internal linking. See which tool offers flat pricing, works on any platform, and provides AI-powered suggestions.',
  },
  {
    slug: 'seojuice',
    name: 'SEOJuice',
    ...
    competitorEdge: [
      { point: 'Broader SEO automation beyond internal linking (meta, content, etc.)' },
      { point: 'White-label reporting for agencies managing multiple clients' },
      { point: 'Fully automated, set-and-forget approach requiring minimal ongoing attention' },
    ],
    bottomLine:
    ...
    metaTitle: 'Linki vs SEOJuice — Internal Linking Tool Comparison',
    metaDescription: 'Compare Linki and SEOJuice for internal linking. See which tool gives you full control, focused suggestions, and works without installing anything.',
  },
]
...
async function main() {
  ...
  console.log('Seeding VS pages...')
  for (const page of vsPages) {
    const result = await post('/vs-pages', page, token)
    console.log(`  Created VS page: ${page.slug}`, result.errors || 'OK')
  }
  console.log('Done.')
}
